                            ...
                            <div class="col-md-6 mx-auto">
                                <form method="POST" action="{{ route('empresa.store') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nombre_empresa" class="form-control @error('nombre_empresa') is-invalid @enderror"  id="nombre_empresa" value="{{ old('nombre_empresa') }}"  placeholder="Ingrese el nombre de la empresa" autofocus>
