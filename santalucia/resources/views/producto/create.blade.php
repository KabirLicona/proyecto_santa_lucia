@extends('layouts.master')  <!-- LLAMADO DEL ESTILO ADMINLTE LLAMAMOS OTRO ARCHIVO layouts.master-->
                ...
                <div class="card">
                    <div class="card-header">
                        <div class=" d-flex align-items-center justify-content-between">
                            ...
                            <!--/*==========================================================
                                 AGREGAR EL REGISTRO CONTENIDO DEL FORMULARIO.
                             ============================================================*/-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 px-5">
                                <div class="form-group">
                                    <label for="imagen">Productos</label>
                            ...
                            <div class="col-md-5 px-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nombre_producto') is-invalid @enderror" name="nombre_producto" id="nombre_producto" value="{{ old('nombre_producto') }}"  placeholder="nombre_producto" autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('precio_compra') is-invalid @enderror" name="precio_compra" id="precio_compra" value="{{ old('precio_compra') }}"  placeholder="precio_compra">
                                    @error('precio_compra')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('precio_venta') is-invalid @enderror" name="precio_venta" id="precio_venta" value="{{ old('precio_venta') }}"  placeholder="precio_venta">
                                    @error('precio_venta')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
...
@endsection
                         ...
                         <!--/*==========================================================
                                LLAMAMOS OTRO REGISTRO EN EL COMBOBOX.
                             ============================================================*/-->
