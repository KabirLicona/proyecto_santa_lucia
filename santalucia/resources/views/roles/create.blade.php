                            ...
                            <div class="col-md-6 mx-auto">
                                <form method="POST" action="{{ route('roles.store') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="role" class="form-control @error('role') is-invalid @enderror" role="role" id="role" value="{{ old('role') }}"  placeholder="Ingrese el nombre del rol" autofocus>
                                        @error('role')
