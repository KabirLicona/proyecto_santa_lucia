                            ...
                            <div class="col-md-6 mx-auto">
                                <form method="POST" action="{{ route('roles.update', $role->id) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="role" class="form-control @error('role') is-invalid @enderror" role="role" id="role" value="{{ $role->name }}"  placeholder="Ingrese el nombre del rol" autofocus>
                                        @error('role')
                                    ...
                                    <div class="form-group d-flex justify-content-end">
                                        <a class="btn btn-default " href="{{ route('roles.index') }}">Cancelar</a>
