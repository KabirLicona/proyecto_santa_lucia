...
class RoleController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        if($role->name == 'admin'){
            session()->flash('error', "Data Role : $role->name No se puede editar");
    ...
    public function update(Request $request, $id)
    {
        ...
        session()->flash('success', "No se puede editar");
    ...
    public function destroy($id)
    {
        ...
        session()->flash('success', "Data Role : $role->name Borrado exitosamente");
